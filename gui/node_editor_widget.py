...
from gui.node_edge import Edge, EDGE_TYPE_BEZIER
from gui.node_graphics_view import QDMGraphicsView
...
class NodeEditorWidget(QWidget):
    ...
    @staticmethod
    def newLeaf():
        Node(scene, "Leaf", inputs=[0, 0, 0], outputs=[1]).setPos(randint(-350, 350), randint(-350, 350))
        return True
